<template>
  ...
  >
    ...
    <section id="make" class="bg-white md:py-8 py-4">
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
          <div class="w-full sm:w-1/2 p-6 mx-auto">
            ...
            <p class="mt-3 text-gray-600 text-base mb-3" v-if="changedImageUrl">
              塗り絵が作成されました！
            </p>
            ...
            <p v-if="!changedImageUrl" class="text-gray-600 md:mb-8 text-base">
              先に塗り絵を作成してください
            </p>
